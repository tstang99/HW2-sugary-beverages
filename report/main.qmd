...
We recommend using a LMM model and fitting two models. The first model uses ZeroCal as a response variable. Our fixed-effect explanatory variables are intervention, Total and DofW, and our random-effect explanatory variable is Site. This model will be useful to assess any association between our explanatory variables and ZeroCal. The second model uses Sugary as a response variable, with the same setup as the previous model. The second model will be ideal for demonstrating any association between the explanatory variables and Sugary.
