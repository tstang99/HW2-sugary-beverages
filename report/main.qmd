...
data$proptotal <- data$Total/max(data$Total)
zerocal_lme = glmer(ZeroCal ~ (1|Site) + (1|Total) + Intervention 
                   + DofW, data=data, family=poisson)
zerocal_lme_2 = glmer(ZeroCal ~ Site + (1|Total) + Intervention 
                   + DofW, data=data, family=poisson)
zerocal_lme_3 = glmmTMB(ZeroCal ~ (1|Site) + (1|Total) + Intervention 
