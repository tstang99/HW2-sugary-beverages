...
\end{align*}
where $Site$ is treated as random effect, and the others as fixed effects. Specifically, the coefficients for $Intervention$ measures the effects of corresponding interventions to the response variables, while controlling the covariates in the model. Interpreting the coefficients for $Intervention$ is crucial for answering the statistical questions.
