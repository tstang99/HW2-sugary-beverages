...
```{r figs, warnings = FALSE, echo=FALSE, fig.width=7,fig.height=6,fig.cap="\\label{fig:figs}Examples of Recommended EDA Plots"}
ggplot(data = data, aes(x = Count, y = ZeroCal, group = Site, color = Site)) +
  geom_line(linewidth = 0.6, alpha = 0.8) + # Adjust line size and transparency
  scale_color_brewer(palette = "Dark2") + # Use a color palette for better distinction
  labs(x = "Days of Experiment", 
       y = "Sales of zero calorie beverages (bottles)", 
  ...
  theme(plot.title = element_text(hjust = 0.5, size = 16, face = "bold"),
        ...
        strip.text = element_text(face = "bold", size = 14), # Style facet labels
