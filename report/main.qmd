...
\end{align*}
Fixed effects are from Intervention, DofW and Total, and random effect measures how the effect of Intervention and baseline of consumption vary across sites. Note that the models are simplified version, especially the omission of link function, and please refer to the appendix for formulated models.
